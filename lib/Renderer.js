  ...
  define(['spectrum/Dispatcher', 'spectrum/Utils'], function(Dispatcher) {
    ...
    return Renderer = (function(_super) {
      ...
      function Renderer(ctx, id) {
        this.ctx = ctx;
        this.id = id;
        this.wedge = __bind(this.wedge, this);
        ...
        this.bezier = __bind(this.bezier, this);
      ...
      Renderer.prototype.bezier = function(cp1x, cp1y, cp2x, cp2y, x, y) {
        this.ctx.beginPath();
      ...
      Renderer.prototype.grid = function(x, y, rows, columns, width, height) {
        var colWidth, i, rowHeight, xpos, ypos, _i, _j, _results;
